...
\copy preliminary from '/common/home/js3181/proj0/hmda_2017_nj_all-records_labels.csv' with (format csv, header true);

alter table preliminary add column id serial;
alter table preliminary add primary key (id);
